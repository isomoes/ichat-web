...
ichat allows you to configure individual models with specific capabilities and parameters. This enables fine-tuned control over how each AI model behaves.
...
Openrouter API allow ichat to detect it for you.
</Note>
...
- When not set: ichat will guess its support
...
- When not set: ichat will guess its support, enable if supported

<Note>
ichat support interleaved thinking(If model support it)
</Note>
