...
ichat supports various media types to enhance your conversations and workflows.

<img src="/ichat-web/img/multimedia/light.webp" class="rounded-lg block dark:hidden" className="rounded-lg"/>
<img src="/ichat-web/img/multimedia/dark.webp" class="rounded-lg hidden dark:block" className="rounded-lg"/>
